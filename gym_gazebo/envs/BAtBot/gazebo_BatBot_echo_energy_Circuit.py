...
class Gazebo_BatBot_echo_energy_Circuit_Env(gazebo_env.GazeboEnv):
    def __init__(self):
    ...
    def step(self, action , debug = False):
        ...
        echo , time  = self.get_observationEnv(debug = debug)
    ...
    def get_observationEnv(self , debug = False):
