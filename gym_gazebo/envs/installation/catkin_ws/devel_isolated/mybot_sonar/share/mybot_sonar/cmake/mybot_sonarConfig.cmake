...
if(mybot_sonar_CONFIG_INCLUDED)
  return()
endif()
set(mybot_sonar_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(mybot_sonar_SOURCE_PREFIX /home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/batbot_simulator/mybot_sonar)
  set(mybot_sonar_DEVEL_PREFIX /home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel_isolated/mybot_sonar)
  set(mybot_sonar_INSTALL_PREFIX "")
  set(mybot_sonar_PREFIX ${mybot_sonar_DEVEL_PREFIX})
else()
  set(mybot_sonar_SOURCE_PREFIX "")
  set(mybot_sonar_DEVEL_PREFIX "")
  set(mybot_sonar_INSTALL_PREFIX /home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install_isolated)
  set(mybot_sonar_PREFIX ${mybot_sonar_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'mybot_sonar' is deprecated")
...
set(mybot_sonar_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(mybot_sonar_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${mybot_sonar_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mybot_sonar' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'mybot_sonar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/batbot_simulator/mybot_sonar/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mybot_sonar_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND mybot_sonar_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(mybot_sonar_LIBRARY_DIRS ${lib_path})
      list(APPEND mybot_sonar_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'mybot_sonar'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND mybot_sonar_LIBRARIES ${lib})
    endif()
  endif()
...
set(mybot_sonar_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${mybot_sonar_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 mybot_sonar_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${mybot_sonar_dep}_FOUND)
      find_package(${mybot_sonar_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mybot_sonar_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(mybot_sonar_INCLUDE_DIRS ${${mybot_sonar_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(mybot_sonar_LIBRARIES ${mybot_sonar_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${mybot_sonar_dep}_LIBRARIES})
  _list_append_deduplicate(mybot_sonar_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(mybot_sonar_LIBRARIES ${mybot_sonar_LIBRARIES})

  _list_append_unique(mybot_sonar_LIBRARY_DIRS ${${mybot_sonar_dep}_LIBRARY_DIRS})
  list(APPEND mybot_sonar_EXPORTED_TARGETS ${${mybot_sonar_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${mybot_sonar_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
