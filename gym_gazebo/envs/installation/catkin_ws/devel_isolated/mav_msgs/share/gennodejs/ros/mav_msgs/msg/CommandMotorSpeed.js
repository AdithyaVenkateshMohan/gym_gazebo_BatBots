...
class CommandMotorSpeed {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CommandMotorSpeed
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CommandMotorSpeed
    let len;
    let data = new CommandMotorSpeed(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandMotorSpeed(null);
...
module.exports = CommandMotorSpeed;
