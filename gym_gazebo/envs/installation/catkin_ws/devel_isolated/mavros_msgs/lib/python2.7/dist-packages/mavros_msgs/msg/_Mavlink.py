...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6BH().pack(_x.is_valid, _x.len, _x.seq, _x.sysid, _x.compid, _x.msgid, _x.checksum))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_valid, _x.len, _x.seq, _x.sysid, _x.compid, _x.msgid, _x.checksum,) = _get_struct_6BH().unpack(str[start:end])
