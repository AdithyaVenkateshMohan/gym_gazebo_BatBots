...
class CommandRollPitchYawrateThrust {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommandRollPitchYawrateThrust(null);
  ...
  static datatype() {
    ...
    return 'mav_msgs/CommandRollPitchYawrateThrust';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandRollPitchYawrateThrust(null);
...
module.exports = CommandRollPitchYawrateThrust;
