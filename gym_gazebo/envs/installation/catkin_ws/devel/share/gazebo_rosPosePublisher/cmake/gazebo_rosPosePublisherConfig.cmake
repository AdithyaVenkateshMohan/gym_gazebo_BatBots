...
if(gazebo_rosPosePublisher_CONFIG_INCLUDED)
  return()
endif()
set(gazebo_rosPosePublisher_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(gazebo_rosPosePublisher_SOURCE_PREFIX /home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/batbot_simulator/gazebo_rosPosePublisher)
  set(gazebo_rosPosePublisher_DEVEL_PREFIX /home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel)
  set(gazebo_rosPosePublisher_INSTALL_PREFIX "")
  set(gazebo_rosPosePublisher_PREFIX ${gazebo_rosPosePublisher_DEVEL_PREFIX})
else()
  set(gazebo_rosPosePublisher_SOURCE_PREFIX "")
  set(gazebo_rosPosePublisher_DEVEL_PREFIX "")
  set(gazebo_rosPosePublisher_INSTALL_PREFIX /home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/install)
  set(gazebo_rosPosePublisher_PREFIX ${gazebo_rosPosePublisher_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'gazebo_rosPosePublisher' is deprecated")
...
set(gazebo_rosPosePublisher_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/batbot_simulator/gazebo_rosPosePublisher/include " STREQUAL " ")
  set(gazebo_rosPosePublisher_INCLUDE_DIRS "")
  set(_include_dirs "/home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/batbot_simulator/gazebo_rosPosePublisher/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${gazebo_rosPosePublisher_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_rosPosePublisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_rosPosePublisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adithya/ReinfLearn/gym/gym-gazebo/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/batbot_simulator/gazebo_rosPosePublisher/${idir}'.  ${_report}")
    endif()
    _list_append_unique(gazebo_rosPosePublisher_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_rosPosePublisher")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND gazebo_rosPosePublisher_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(gazebo_rosPosePublisher_LIBRARY_DIRS ${lib_path})
      list(APPEND gazebo_rosPosePublisher_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'gazebo_rosPosePublisher'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND gazebo_rosPosePublisher_LIBRARIES ${lib})
    endif()
  endif()
...
set(gazebo_rosPosePublisher_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${gazebo_rosPosePublisher_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "gazebo_msgs;gazebo_plugin;gazebo_ros;geometry_msgs;roscpp;std_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 gazebo_rosPosePublisher_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${gazebo_rosPosePublisher_dep}_FOUND)
      find_package(${gazebo_rosPosePublisher_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gazebo_rosPosePublisher_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(gazebo_rosPosePublisher_INCLUDE_DIRS ${${gazebo_rosPosePublisher_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(gazebo_rosPosePublisher_LIBRARIES ${gazebo_rosPosePublisher_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${gazebo_rosPosePublisher_dep}_LIBRARIES})
  _list_append_deduplicate(gazebo_rosPosePublisher_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(gazebo_rosPosePublisher_LIBRARIES ${gazebo_rosPosePublisher_LIBRARIES})

  _list_append_unique(gazebo_rosPosePublisher_LIBRARY_DIRS ${${gazebo_rosPosePublisher_dep}_LIBRARY_DIRS})
  list(APPEND gazebo_rosPosePublisher_EXPORTED_TARGETS ${${gazebo_rosPosePublisher_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${gazebo_rosPosePublisher_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
